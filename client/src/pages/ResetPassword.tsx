...
export default function ResetPassword() {
  ...
  const request = trpc.auth.requestPasswordReset.useMutation({ onSuccess: result => { setRequested(true); setMessage(result.developmentCode ? `Development reset code: ${result.developmentCode}` : "Email delivery is disabled; use a recovery code from the current development session."); } });
