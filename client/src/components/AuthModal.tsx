...
export function AuthModal({ open, onOpenChange, redirect = "/learn" }: AuthModalProps) {
  ...
  useEffect(() => { if (open) { setError(""); setMessage(""); setResetRequested(false); } }, [open, mode]);
  ...
  async function submit(event: React.FormEvent) {
    ...
    try {
      ...
      if (!code) { await requestReset.mutateAsync({ email }); setResetRequested(true); setMessage(""); return; }
