...
var chapterQuizBank = {
  "english-for-technical-work": [{ "id": "eng-q1", "prompt": "What makes technical English easier to act on?", "options": ["A clear purpose, audience, structure, and checkable wording", "A larger file", "A confident tone only", "More configuration without a goal"], "answer": 0, "explanation": "Technical English reduces ambiguity by making purpose, audience, structure, and expected action visible." }, { "id": "eng-q2", "prompt": "What is the strongest beginner practice for this route?", "options": ["Make a small change, observe the result, and explain the evidence", "Skip the experiment and copy a final answer", "Avoid recording failures", "Use complexity as proof of understanding"], "answer": 0, "explanation": "Small observable experiments create feedback and make reasoning inspectable." }, { "id": "eng-q3", "prompt": "What should a learner do when a result is surprising?", "options": ["Reduce the problem, state a hypothesis, and test one variable", "Hide the result", "Change everything at once", "Assume the tool is always wrong"], "answer": 0, "explanation": "Reducing the problem and changing one variable turns surprise into useful evidence." }],
  "clear-communication": [{ "id": "com-q1", "prompt": "What is the first move in a difficult workplace conversation?", "options": ["Name the shared outcome and the observable situation", "A larger file", "A confident tone only", "More configuration without a goal"], "answer": 0, "explanation": "A shared outcome and observable situation give the conversation a concrete starting point." }, { "id": "com-q2", "prompt": "What is the strongest beginner practice for this route?", "options": ["Make a small change, observe the result, and explain the evidence", "Skip the experiment and copy a final answer", "Avoid recording failures", "Use complexity as proof of understanding"], "answer": 0, "explanation": "Small observable experiments create feedback and make reasoning inspectable." }, { "id": "com-q3", "prompt": "What should a learner do when a result is surprising?", "options": ["Reduce the problem, state a hypothesis, and test one variable", "Hide the result", "Change everything at once", "Assume the tool is always wrong"], "answer": 0, "explanation": "Reducing the problem and changing one variable turns surprise into useful evidence." }],
  "professional-presence": [{ "id": "pre-q1", "prompt": "What creates credible professional presence?", "options": ["Prepared thinking, reliable follow-through, and respectful clarity", "A larger file", "A confident tone only", "More configuration without a goal"], "answer": 0, "explanation": "Presence is a pattern of preparation and dependable behavior, not performance or status signals." }, { "id": "pre-q2", "prompt": "What is the strongest beginner practice for this route?", "options": ["Make a small change, observe the result, and explain the evidence", "Skip the experiment and copy a final answer", "Avoid recording failures", "Use complexity as proof of understanding"], "answer": 0, "explanation": "Small observable experiments create feedback and make reasoning inspectable." }, { "id": "pre-q3", "prompt": "What should a learner do when a result is surprising?", "options": ["Reduce the problem, state a hypothesis, and test one variable", "Hide the result", "Change everything at once", "Assume the tool is always wrong"], "answer": 0, "explanation": "Reducing the problem and changing one variable turns surprise into useful evidence." }],
  "critical-thinking": [{ "id": "crit-q1", "prompt": "What is the difference between a claim and evidence?", "options": ["A claim is what is asserted; evidence is what supports or challenges it", "A larger file", "A confident tone only", "More configuration without a goal"], "answer": 0, "explanation": "Separating claim from evidence prevents confidence, authority, or repetition from being mistaken for support." }, { "id": "crit-q2", "prompt": "What is the strongest beginner practice for this route?", "options": ["Make a small change, observe the result, and explain the evidence", "Skip the experiment and copy a final answer", "Avoid recording failures", "Use complexity as proof of understanding"], "answer": 0, "explanation": "Small observable experiments create feedback and make reasoning inspectable." }, { "id": "crit-q3", "prompt": "What should a learner do when a result is surprising?", "options": ["Reduce the problem, state a hypothesis, and test one variable", "Hide the result", "Change everything at once", "Assume the tool is always wrong"], "answer": 0, "explanation": "Reducing the problem and changing one variable turns surprise into useful evidence." }],
  "high-signal-writing": [{ "id": "write-q1", "prompt": "What makes a work document high-signal?", "options": ["The reader can quickly find the decision, evidence, and requested action", "A larger file", "A confident tone only", "More configuration without a goal"], "answer": 0, "explanation": "High-signal writing respects the reader\u2019s attention and makes the operational point easy to locate." }, { "id": "write-q2", "prompt": "What is the strongest beginner practice for this route?", "options": ["Make a small change, observe the result, and explain the evidence", "Skip the experiment and copy a final answer", "Avoid recording failures", "Use complexity as proof of understanding"], "answer": 0, "explanation": "Small observable experiments create feedback and make reasoning inspectable." }, { "id": "write-q3", "prompt": "What should a learner do when a result is surprising?", "options": ["Reduce the problem, state a hypothesis, and test one variable", "Hide the result", "Change everything at once", "Assume the tool is always wrong"], "answer": 0, "explanation": "Reducing the problem and changing one variable turns surprise into useful evidence." }],
  "learning-systems": [{ "id": "learn-q1", "prompt": "What turns study time into durable learning?", "options": ["Retrieval, feedback, spacing, and deliberate practice", "A larger file", "A confident tone only", "More configuration without a goal"], "answer": 0, "explanation": "Durable learning comes from recalling and applying ideas over time, not from rereading alone." }, { "id": "learn-q2", "prompt": "What is the strongest beginner practice for this route?", "options": ["Make a small change, observe the result, and explain the evidence", "Skip the experiment and copy a final answer", "Avoid recording failures", "Use complexity as proof of understanding"], "answer": 0, "explanation": "Small observable experiments create feedback and make reasoning inspectable." }, { "id": "learn-q3", "prompt": "What should a learner do when a result is surprising?", "options": ["Reduce the problem, state a hypothesis, and test one variable", "Hide the result", "Change everything at once", "Assume the tool is always wrong"], "answer": 0, "explanation": "Reducing the problem and changing one variable turns surprise into useful evidence." }],
  "career-navigation": [{ "id": "career-q1", "prompt": "What makes a career goal actionable?", "options": ["A target role, current evidence, skill gaps, and a next experiment", "A larger file", "A confident tone only", "More configuration without a goal"], "answer": 0, "explanation": "A goal becomes actionable when it can be tested through evidence and small experiments." }, { "id": "career-q2", "prompt": "What is the strongest beginner practice for this route?", "options": ["Make a small change, observe the result, and explain the evidence", "Skip the experiment and copy a final answer", "Avoid recording failures", "Use complexity as proof of understanding"], "answer": 0, "explanation": "Small observable experiments create feedback and make reasoning inspectable." }, { "id": "career-q3", "prompt": "What should a learner do when a result is surprising?", "options": ["Reduce the problem, state a hypothesis, and test one variable", "Hide the result", "Change everything at once", "Assume the tool is always wrong"], "answer": 0, "explanation": "Reducing the problem and changing one variable turns surprise into useful evidence." }],
  "decision-making": [{ "id": "decide-q1", "prompt": "What should a decision brief clarify first?", "options": ["The decision, options, constraints, and evaluation criteria", "A larger file", "A confident tone only", "More configuration without a goal"], "answer": 0, "explanation": "Decision quality improves when the problem and the standard for choosing are explicit." }, { "id": "decide-q2", "prompt": "What is the strongest beginner practice for this route?", "options": ["Make a small change, observe the result, and explain the evidence", "Skip the experiment and copy a final answer", "Avoid recording failures", "Use complexity as proof of understanding"], "answer": 0, "explanation": "Small observable experiments create feedback and make reasoning inspectable." }, { "id": "decide-q3", "prompt": "What should a learner do when a result is surprising?", "options": ["Reduce the problem, state a hypothesis, and test one variable", "Hide the result", "Change everything at once", "Assume the tool is always wrong"], "answer": 0, "explanation": "Reducing the problem and changing one variable turns surprise into useful evidence." }],
  "negotiation-and-collaboration": [{ "id": "nego-q1", "prompt": "What is the first preparation step for a negotiation?", "options": ["Separate interests, constraints, alternatives, and the shared problem", "A larger file", "A confident tone only", "More configuration without a goal"], "answer": 0, "explanation": "Preparation makes it possible to negotiate the problem rather than react to positions." }, { "id": "nego-q2", "prompt": "What is the strongest beginner practice for this route?", "options": ["Make a small change, observe the result, and explain the evidence", "Skip the experiment and copy a final answer", "Avoid recording failures", "Use complexity as proof of understanding"], "answer": 0, "explanation": "Small observable experiments create feedback and make reasoning inspectable." }, { "id": "nego-q3", "prompt": "What should a learner do when a result is surprising?", "options": ["Reduce the problem, state a hypothesis, and test one variable", "Hide the result", "Change everything at once", "Assume the tool is always wrong"], "answer": 0, "explanation": "Reducing the problem and changing one variable turns surprise into useful evidence." }],
  "python-engineering": [{ "id": "py-q1", "prompt": "What is the clearest way to understand a Python program\u2019s behavior?", "options": ["Trace values, control flow, data structures, and boundaries with small experiments", "A larger file", "A confident tone only", "More configuration without a goal"], "answer": 0, "explanation": "Small experiments expose Python\u2019s runtime behavior more reliably than memorizing syntax." }, { "id": "py-q2", "prompt": "What is the strongest beginner practice for this route?", "options": ["Make a small change, observe the result, and explain the evidence", "Skip the experiment and copy a final answer", "Avoid recording failures", "Use complexity as proof of understanding"], "answer": 0, "explanation": "Small observable experiments create feedback and make reasoning inspectable." }, { "id": "py-q3", "prompt": "What should a learner do when a result is surprising?", "options": ["Reduce the problem, state a hypothesis, and test one variable", "Hide the result", "Change everything at once", "Assume the tool is always wrong"], "answer": 0, "explanation": "Reducing the problem and changing one variable turns surprise into useful evidence." }],
  "networking-systems": [
  ...
  "c-foundations": [
    { id: "c-q1", prompt: "What does a compiler do with a C source file?", options: ["Translates human-readable source into a form the machine can execute", "Stores the program in a PDF", "Routes network packets", "Creates a database table"], answer: 0, explanation: "A compiler translates source code into object code or an executable through the toolchain." },
    { id: "c-q2", prompt: "Why does a C string need a terminator?", options: ["Functions need a boundary to know where the character sequence ends", "It makes every string immutable", "It allocates heap memory automatically", "It prevents all input errors"], answer: 0, explanation: "Traditional C strings use a null character to mark the end of the character sequence." },
    { id: "c-q3", prompt: "What does dereferencing a pointer mean?", options: ["Accessing the object stored at the pointer's address", "Converting C into C++", "Freeing memory automatically", "Starting a new process"], answer: 0, explanation: "The dereference operator accesses the object designated by a valid pointer." },
    { id: "c-q4", prompt: "What is the owner of dynamically allocated memory responsible for?", options: ["Tracking its lifetime and releasing it exactly once", "Making the memory global", "Ignoring allocation failure", "Changing the compiler standard"], answer: 0, explanation: "Explicit ownership means a program must define success, failure, and cleanup paths." },
    { id: "c-q5", prompt: "What makes a C input boundary safer?", options: ["A defined maximum length, checked conversion, and explicit failure behavior", "Reading until memory happens to stop", "Ignoring return values", "Using a larger global buffer"], answer: 0, explanation: "Safe input handling controls length and conversion and makes rejected input visible." },
    { id: "c-q6", prompt: "What should a beginner include in a finished C project?", options: ["A reproducible build, tests or sample runs, explanation, and known limitations", "Only a screenshot", "Every possible C feature", "No error handling"], answer: 0, explanation: "A small, explainable artifact with evidence and limits is stronger than an unreviewed feature pile." }
  ]
};
var finalAssessmentBank = {
  "english-for-technical-work": [{ "id": "eng-f1", "prompt": "How should a technical writer handle an uncertain claim?", "options": ["State the evidence, uncertainty, assumptions, and next verification step", "Remove all caveats", "Choose the most complicated option", "Treat a first draft as final evidence"], "answer": 0, "explanation": "Honest technical writing makes uncertainty inspectable instead of hiding it behind confident language." }, { "id": "eng-f2", "prompt": "Which artifact best demonstrates applied understanding?", "options": ["A working artifact with a short explanation, evidence, tests, and known limits", "A screenshot without context", "A copied solution with no attribution", "A list of terms"], "answer": 0, "explanation": "Applied understanding is visible in an artifact and the reasoning and evidence around it." }, { "id": "eng-f3", "prompt": "What should an advanced learner do before claiming improvement?", "options": ["Define a baseline, compare a repeatable case, and state limitations", "Choose the most flattering example", "Remove difficult cases", "Rely on intuition alone"], "answer": 0, "explanation": "A baseline and repeatable comparison make improvement claims inspectable." }, { "id": "eng-f4", "prompt": "What is a responsible response to an unresolved limitation?", "options": ["Document it, bound its impact, and define the next investigation", "Ignore it", "Call the work complete without qualification", "Blame the learner"], "answer": 0, "explanation": "Explicit limits protect the learner and make future work more focused." }, { "id": "eng-f5", "prompt": "What does the final assessment primarily test?", "options": ["Whether the learner can apply concepts, justify choices, and inspect failure", "Whether the learner remembers every sentence", "Whether the learner used the largest tool", "Whether the learner avoided difficult cases"], "answer": 0, "explanation": "The final test should assess transfer, reasoning, and failure-aware practice rather than memorization alone." }],
  "clear-communication": [{ "id": "com-f1", "prompt": "What makes a communication decision durable?", "options": ["A recorded decision, owner, rationale, and explicit follow-up", "Remove all caveats", "Choose the most complicated option", "Treat a first draft as final evidence"], "answer": 0, "explanation": "Durable communication leaves enough context for others to act without reconstructing the conversation." }, { "id": "com-f2", "prompt": "Which artifact best demonstrates applied understanding?", "options": ["A working artifact with a short explanation, evidence, tests, and known limits", "A screenshot without context", "A copied solution with no attribution", "A list of terms"], "answer": 0, "explanation": "Applied understanding is visible in an artifact and the reasoning and evidence around it." }, { "id": "com-f3", "prompt": "What should an advanced learner do before claiming improvement?", "options": ["Define a baseline, compare a repeatable case, and state limitations", "Choose the most flattering example", "Remove difficult cases", "Rely on intuition alone"], "answer": 0, "explanation": "A baseline and repeatable comparison make improvement claims inspectable." }, { "id": "com-f4", "prompt": "What is a responsible response to an unresolved limitation?", "options": ["Document it, bound its impact, and define the next investigation", "Ignore it", "Call the work complete without qualification", "Blame the learner"], "answer": 0, "explanation": "Explicit limits protect the learner and make future work more focused." }, { "id": "com-f5", "prompt": "What does the final assessment primarily test?", "options": ["Whether the learner can apply concepts, justify choices, and inspect failure", "Whether the learner remembers every sentence", "Whether the learner used the largest tool", "Whether the learner avoided difficult cases"], "answer": 0, "explanation": "The final test should assess transfer, reasoning, and failure-aware practice rather than memorization alone." }],
  "professional-presence": [{ "id": "pre-f1", "prompt": "What should a professional handoff include?", "options": ["Context, decision, evidence, owner, risks, and the next checkpoint", "Remove all caveats", "Choose the most complicated option", "Treat a first draft as final evidence"], "answer": 0, "explanation": "A strong handoff transfers enough context and accountability for another person to continue the work." }, { "id": "pre-f2", "prompt": "Which artifact best demonstrates applied understanding?", "options": ["A working artifact with a short explanation, evidence, tests, and known limits", "A screenshot without context", "A copied solution with no attribution", "A list of terms"], "answer": 0, "explanation": "Applied understanding is visible in an artifact and the reasoning and evidence around it." }, { "id": "pre-f3", "prompt": "What should an advanced learner do before claiming improvement?", "options": ["Define a baseline, compare a repeatable case, and state limitations", "Choose the most flattering example", "Remove difficult cases", "Rely on intuition alone"], "answer": 0, "explanation": "A baseline and repeatable comparison make improvement claims inspectable." }, { "id": "pre-f4", "prompt": "What is a responsible response to an unresolved limitation?", "options": ["Document it, bound its impact, and define the next investigation", "Ignore it", "Call the work complete without qualification", "Blame the learner"], "answer": 0, "explanation": "Explicit limits protect the learner and make future work more focused." }, { "id": "pre-f5", "prompt": "What does the final assessment primarily test?", "options": ["Whether the learner can apply concepts, justify choices, and inspect failure", "Whether the learner remembers every sentence", "Whether the learner used the largest tool", "Whether the learner avoided difficult cases"], "answer": 0, "explanation": "The final test should assess transfer, reasoning, and failure-aware practice rather than memorization alone." }],
  "critical-thinking": [{ "id": "crit-f1", "prompt": "What should a critical-thinking review test first?", "options": ["Definitions, assumptions, causal links, counterexamples, and decision consequences", "Remove all caveats", "Choose the most complicated option", "Treat a first draft as final evidence"], "answer": 0, "explanation": "A rigorous review examines the structure beneath the conclusion, not only whether the conclusion sounds plausible." }, { "id": "crit-f2", "prompt": "Which artifact best demonstrates applied understanding?", "options": ["A working artifact with a short explanation, evidence, tests, and known limits", "A screenshot without context", "A copied solution with no attribution", "A list of terms"], "answer": 0, "explanation": "Applied understanding is visible in an artifact and the reasoning and evidence around it." }, { "id": "crit-f3", "prompt": "What should an advanced learner do before claiming improvement?", "options": ["Define a baseline, compare a repeatable case, and state limitations", "Choose the most flattering example", "Remove difficult cases", "Rely on intuition alone"], "answer": 0, "explanation": "A baseline and repeatable comparison make improvement claims inspectable." }, { "id": "crit-f4", "prompt": "What is a responsible response to an unresolved limitation?", "options": ["Document it, bound its impact, and define the next investigation", "Ignore it", "Call the work complete without qualification", "Blame the learner"], "answer": 0, "explanation": "Explicit limits protect the learner and make future work more focused." }, { "id": "crit-f5", "prompt": "What does the final assessment primarily test?", "options": ["Whether the learner can apply concepts, justify choices, and inspect failure", "Whether the learner remembers every sentence", "Whether the learner used the largest tool", "Whether the learner avoided difficult cases"], "answer": 0, "explanation": "The final test should assess transfer, reasoning, and failure-aware practice rather than memorization alone." }],
  "high-signal-writing": [{ "id": "write-f1", "prompt": "How should a writer revise a complex technical proposal?", "options": ["Separate the decision, context, alternatives, evidence, risks, and implementation plan", "Remove all caveats", "Choose the most complicated option", "Treat a first draft as final evidence"], "answer": 0, "explanation": "A stable decision structure lets readers evaluate trade-offs without confusing background with recommendation." }, { "id": "write-f2", "prompt": "Which artifact best demonstrates applied understanding?", "options": ["A working artifact with a short explanation, evidence, tests, and known limits", "A screenshot without context", "A copied solution with no attribution", "A list of terms"], "answer": 0, "explanation": "Applied understanding is visible in an artifact and the reasoning and evidence around it." }, { "id": "write-f3", "prompt": "What should an advanced learner do before claiming improvement?", "options": ["Define a baseline, compare a repeatable case, and state limitations", "Choose the most flattering example", "Remove difficult cases", "Rely on intuition alone"], "answer": 0, "explanation": "A baseline and repeatable comparison make improvement claims inspectable." }, { "id": "write-f4", "prompt": "What is a responsible response to an unresolved limitation?", "options": ["Document it, bound its impact, and define the next investigation", "Ignore it", "Call the work complete without qualification", "Blame the learner"], "answer": 0, "explanation": "Explicit limits protect the learner and make future work more focused." }, { "id": "write-f5", "prompt": "What does the final assessment primarily test?", "options": ["Whether the learner can apply concepts, justify choices, and inspect failure", "Whether the learner remembers every sentence", "Whether the learner used the largest tool", "Whether the learner avoided difficult cases"], "answer": 0, "explanation": "The final test should assess transfer, reasoning, and failure-aware practice rather than memorization alone." }],
  "learning-systems": [{ "id": "learn-f1", "prompt": "What should a learning system measure?", "options": ["The target skill, evidence of transfer, error patterns, and the next practice decision", "Remove all caveats", "Choose the most complicated option", "Treat a first draft as final evidence"], "answer": 0, "explanation": "A useful learning system measures behavior and adaptation, not only hours spent or pages completed." }, { "id": "learn-f2", "prompt": "Which artifact best demonstrates applied understanding?", "options": ["A working artifact with a short explanation, evidence, tests, and known limits", "A screenshot without context", "A copied solution with no attribution", "A list of terms"], "answer": 0, "explanation": "Applied understanding is visible in an artifact and the reasoning and evidence around it." }, { "id": "learn-f3", "prompt": "What should an advanced learner do before claiming improvement?", "options": ["Define a baseline, compare a repeatable case, and state limitations", "Choose the most flattering example", "Remove difficult cases", "Rely on intuition alone"], "answer": 0, "explanation": "A baseline and repeatable comparison make improvement claims inspectable." }, { "id": "learn-f4", "prompt": "What is a responsible response to an unresolved limitation?", "options": ["Document it, bound its impact, and define the next investigation", "Ignore it", "Call the work complete without qualification", "Blame the learner"], "answer": 0, "explanation": "Explicit limits protect the learner and make future work more focused." }, { "id": "learn-f5", "prompt": "What does the final assessment primarily test?", "options": ["Whether the learner can apply concepts, justify choices, and inspect failure", "Whether the learner remembers every sentence", "Whether the learner used the largest tool", "Whether the learner avoided difficult cases"], "answer": 0, "explanation": "The final test should assess transfer, reasoning, and failure-aware practice rather than memorization alone." }],
  "career-navigation": [{ "id": "career-f1", "prompt": "What makes a portfolio signal credible?", "options": ["A real artifact, clear contribution, evidence of decisions, and an honest account of limits", "Remove all caveats", "Choose the most complicated option", "Treat a first draft as final evidence"], "answer": 0, "explanation": "Credible career evidence shows what was built, why choices were made, and what remains imperfect." }, { "id": "career-f2", "prompt": "Which artifact best demonstrates applied understanding?", "options": ["A working artifact with a short explanation, evidence, tests, and known limits", "A screenshot without context", "A copied solution with no attribution", "A list of terms"], "answer": 0, "explanation": "Applied understanding is visible in an artifact and the reasoning and evidence around it." }, { "id": "career-f3", "prompt": "What should an advanced learner do before claiming improvement?", "options": ["Define a baseline, compare a repeatable case, and state limitations", "Choose the most flattering example", "Remove difficult cases", "Rely on intuition alone"], "answer": 0, "explanation": "A baseline and repeatable comparison make improvement claims inspectable." }, { "id": "career-f4", "prompt": "What is a responsible response to an unresolved limitation?", "options": ["Document it, bound its impact, and define the next investigation", "Ignore it", "Call the work complete without qualification", "Blame the learner"], "answer": 0, "explanation": "Explicit limits protect the learner and make future work more focused." }, { "id": "career-f5", "prompt": "What does the final assessment primarily test?", "options": ["Whether the learner can apply concepts, justify choices, and inspect failure", "Whether the learner remembers every sentence", "Whether the learner used the largest tool", "Whether the learner avoided difficult cases"], "answer": 0, "explanation": "The final test should assess transfer, reasoning, and failure-aware practice rather than memorization alone." }],
  "decision-making": [{ "id": "decide-f1", "prompt": "When is a reversible experiment better than a final commitment?", "options": ["When uncertainty is high and a low-cost test can produce useful evidence", "Remove all caveats", "Choose the most complicated option", "Treat a first draft as final evidence"], "answer": 0, "explanation": "Reversible experiments preserve optionality while converting uncertainty into information." }, { "id": "decide-f2", "prompt": "Which artifact best demonstrates applied understanding?", "options": ["A working artifact with a short explanation, evidence, tests, and known limits", "A screenshot without context", "A copied solution with no attribution", "A list of terms"], "answer": 0, "explanation": "Applied understanding is visible in an artifact and the reasoning and evidence around it." }, { "id": "decide-f3", "prompt": "What should an advanced learner do before claiming improvement?", "options": ["Define a baseline, compare a repeatable case, and state limitations", "Choose the most flattering example", "Remove difficult cases", "Rely on intuition alone"], "answer": 0, "explanation": "A baseline and repeatable comparison make improvement claims inspectable." }, { "id": "decide-f4", "prompt": "What is a responsible response to an unresolved limitation?", "options": ["Document it, bound its impact, and define the next investigation", "Ignore it", "Call the work complete without qualification", "Blame the learner"], "answer": 0, "explanation": "Explicit limits protect the learner and make future work more focused." }, { "id": "decide-f5", "prompt": "What does the final assessment primarily test?", "options": ["Whether the learner can apply concepts, justify choices, and inspect failure", "Whether the learner remembers every sentence", "Whether the learner used the largest tool", "Whether the learner avoided difficult cases"], "answer": 0, "explanation": "The final test should assess transfer, reasoning, and failure-aware practice rather than memorization alone." }],
  "negotiation-and-collaboration": [{ "id": "nego-f1", "prompt": "What makes a collaboration agreement robust?", "options": ["Shared outcomes, decision rights, responsibilities, escalation paths, and review points", "Remove all caveats", "Choose the most complicated option", "Treat a first draft as final evidence"], "answer": 0, "explanation": "Collaboration becomes dependable when coordination rules are explicit before pressure arrives." }, { "id": "nego-f2", "prompt": "Which artifact best demonstrates applied understanding?", "options": ["A working artifact with a short explanation, evidence, tests, and known limits", "A screenshot without context", "A copied solution with no attribution", "A list of terms"], "answer": 0, "explanation": "Applied understanding is visible in an artifact and the reasoning and evidence around it." }, { "id": "nego-f3", "prompt": "What should an advanced learner do before claiming improvement?", "options": ["Define a baseline, compare a repeatable case, and state limitations", "Choose the most flattering example", "Remove difficult cases", "Rely on intuition alone"], "answer": 0, "explanation": "A baseline and repeatable comparison make improvement claims inspectable." }, { "id": "nego-f4", "prompt": "What is a responsible response to an unresolved limitation?", "options": ["Document it, bound its impact, and define the next investigation", "Ignore it", "Call the work complete without qualification", "Blame the learner"], "answer": 0, "explanation": "Explicit limits protect the learner and make future work more focused." }, { "id": "nego-f5", "prompt": "What does the final assessment primarily test?", "options": ["Whether the learner can apply concepts, justify choices, and inspect failure", "Whether the learner remembers every sentence", "Whether the learner used the largest tool", "Whether the learner avoided difficult cases"], "answer": 0, "explanation": "The final test should assess transfer, reasoning, and failure-aware practice rather than memorization alone." }],
  "python-engineering": [{ "id": "py-f1", "prompt": "What makes a Python service production-ready?", "options": ["Explicit interfaces, tests, observability, dependency control, failure handling, and reproducible deployment", "Remove all caveats", "Choose the most complicated option", "Treat a first draft as final evidence"], "answer": 0, "explanation": "Production readiness is an operating contract around the code, not simply a successful local run." }, { "id": "py-f2", "prompt": "Which artifact best demonstrates applied understanding?", "options": ["A working artifact with a short explanation, evidence, tests, and known limits", "A screenshot without context", "A copied solution with no attribution", "A list of terms"], "answer": 0, "explanation": "Applied understanding is visible in an artifact and the reasoning and evidence around it." }, { "id": "py-f3", "prompt": "What should an advanced learner do before claiming improvement?", "options": ["Define a baseline, compare a repeatable case, and state limitations", "Choose the most flattering example", "Remove difficult cases", "Rely on intuition alone"], "answer": 0, "explanation": "A baseline and repeatable comparison make improvement claims inspectable." }, { "id": "py-f4", "prompt": "What is a responsible response to an unresolved limitation?", "options": ["Document it, bound its impact, and define the next investigation", "Ignore it", "Call the work complete without qualification", "Blame the learner"], "answer": 0, "explanation": "Explicit limits protect the learner and make future work more focused." }, { "id": "py-f5", "prompt": "What does the final assessment primarily test?", "options": ["Whether the learner can apply concepts, justify choices, and inspect failure", "Whether the learner remembers every sentence", "Whether the learner used the largest tool", "Whether the learner avoided difficult cases"], "answer": 0, "explanation": "The final test should assess transfer, reasoning, and failure-aware practice rather than memorization alone." }],
  "cpp-engineering": [
  ...
  "c-foundations": [
    { id: "c-f1", prompt: "Which C project is most ready to share?", options: ["One with a reproducible build, tests or sample runs, clear scope, and known limitations", "One that only works on the author's machine", "One with no failure handling", "One that hides its source"], answer: 0, explanation: "A useful handoff lets another person build, inspect, and challenge the program." },
    { id: "c-f2", prompt: "What is a strong way to review pointer code?", options: ["State valid objects, ownership, lifetime, and cleanup for every pointer", "Assume every non-null pointer is safe", "Remove all checks", "Use comments instead of tests"], answer: 0, explanation: "Pointer safety depends on validity, lifetime, ownership, and the paths that release resources." },
    { id: "c-f3", prompt: "Why should C programs compile with warnings enabled?", options: ["Warnings expose suspicious code before it becomes a runtime failure", "Warnings replace testing", "Warnings make memory safe automatically", "Warnings remove the need for design"], answer: 0, explanation: "Compiler diagnostics are an early feedback channel, but they complement tests and review." },
    { id: "c-f4", prompt: "What does secure C practice emphasize?", options: ["Explicit bounds, checked conversions, validated input, and defined failure behavior", "Bigger buffers without limits", "Ignoring return values", "Trusting all external input"], answer: 0, explanation: "Secure C makes boundaries and failure behavior explicit rather than relying on optimistic assumptions." },
    { id: "c-f5", prompt: "What should the C capstone demonstrate?", options: ["A small system whose behavior, build, tests, and limits can be explained", "Every feature in the language", "A benchmark without a workload", "A program with no documentation"], answer: 0, explanation: "The capstone is evidence of disciplined construction, not a claim that the program has no possible bugs." }
  ],
  "ai-product-systems": [
